	...
	<div class="social-media">
		<div class="social-media-inner container text-center">
			<ul class="list-inline">
				<li class="twitter-follow"><a href="#" class="twitter-follow-button" data-show-count="false">技术：广州付费易有限责任公司</a>
				</li><!--//twitter-follow-->
				<li class="twitter-tweet">
					<a href="#" class="twitter-share-button" data-via="3rdwave_themes" data-hashtags="bootstrap">邮箱：99999@qq.com</a>
				</li><!--//twitter-tweet-->
