		...
		<script type="text/javascript">
			$(function(){
				...
				$("#name").blur(function(){
					...
					if (true){
						/** 异步验证用户名是否重复 */
						$.post("${path}/admin/business/validComAjax.jspx", {name : name, id :"${company.id}"}, function(data, status){
...
<body>
	...
	<table align="center">
		<s:form id="updateCompanyForm" action="/admin/business/updateCompany.jspx" method="post" theme="simple">
			...
			<tr>
				<td>单价：</td>
				<td>
					<s:textfield name="company.price" size="18" maxlength="10" id="price"/>元/<span id="unit"></span>
				</td>
			</tr>
			<tr>
